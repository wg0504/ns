...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.9.0/V8/Debugger.uno
// -----------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.9.0/V8/Debugger.uno");
